            ...
            <form method="POST" action="submit-login.php"> 
              <div class="input-boxes">
                <div class="input-box">
                  ...
                  <input type="text" id="email" placeholder="Enter your email" name="email" value="" required>
                </div>
                
                <div class="input-box">
                  <i class="fas fa-lock"></i>
                  <input type="password" id="pass" placeholder="Enter your password" name="pass" value="" required>
                </div>
